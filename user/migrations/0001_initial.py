    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Delivered', 'Delivered'), ('Rejected', 'Rejected'), ('Accepted', 'Accepted'), ('Dispatched', 'Dispatched'), ('Cancelled', 'Cancelled'), ('Pending', 'Pending')], default='Pending', max_length=20)),
